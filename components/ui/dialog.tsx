        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            render={
              <Button
                variant="ghost"
                className="absolute top-1 right-1 z-[120] size-11 flex items-center justify-center rounded-full hover:bg-black/5 active:bg-black/10 transition-colors"
                size="icon"
              />
            }
          >
            <XIcon className="size-6 text-slate-500" />
